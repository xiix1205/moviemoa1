...
-->             
         ...
         <div id="the_info">
               <caption><p class="info_name">강릉시 영상미디어센터</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>강원도 강릉시 교동 율곡로 2923-12 강릉시립모루도서관 4층</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>033-640-4961</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.gnmedia.or.kr/" target="_blank">http://www.gnmedia.or.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(37.763833, 128.891201),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.763833, 128.891201),    
